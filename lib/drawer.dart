        ...
        child: ListView(
          ...
          children: [
            UserAccountsDrawerHeader(
              ...
              accountEmail: Text('user@goodspend.co.id', style: TextStyle(color: Color.fromRGBO(127, 195, 126, 1))),
              accountName: Text(
                "User",
                style: TextStyle(fontSize: 20, color: Color.fromRGBO(127, 195, 126, 1)),
              ),
